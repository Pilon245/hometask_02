...
import {blogsValidation, postsValidation} from "../middlewares/bodyValidation";
...
blogsRouter.post('/blogs/:blogId/posts',authMiddleware,postOnblogIdValodation,inputQueryValidation,postsValidation
    ,inputBodyValidation,postControllers.createPostonBlog)
